...
Namespace Classes
    Public Class Operations
        ...
        Public Async Function IterateFolders(folderName As String, searchString As String, token As CancellationToken) As Task(Of List(Of String))
            ...
            Try
                For Each fileName In Directory.EnumerateFiles(folderName, "*.vb", SearchOption.AllDirectories)
                    ...
                    If contents.IndexOf(searchString, 0, StringComparison.CurrentCultureIgnoreCase) > -1 Then
                        foundList.Add(fileName)
                    End If
